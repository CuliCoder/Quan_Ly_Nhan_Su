...
namespace Quan_Ly_Nhan_Su.GUI.LuongThuongUserControl
{
    public partial class LuongThuong : UserControl
    {
        ...
        // Thêm biến lưu tháng/năm hiện tại đang xem
        private int _currentViewingMonth = DateTime.Now.Month;
        private int _currentViewingYear = DateTime.Now.Year;
        ...
        private void BtnTinhLuong_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // SỬ DỤNG THÁNG/NĂM ĐÃ LƯU KHI CLICK "XEM CHI TIẾT"
                int thang = _currentViewingMonth;
                int nam = _currentViewingYear;

                // Truyền cả tháng/năm vào BillFormGUI
                using (var form = new BillFormGUI(maNhanVien, thang, nam))
                {
            ...
            {
                MessageBox.Show($"Lỗi khi xuất phiếu lương: {ex.Message}", 
        ...
        private void dataMonthlySummary_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataMonthlySummary.Columns[e.ColumnIndex] is DataGridViewButtonColumn || dataMonthlySummary.Columns[e.ColumnIndex].Name == "XemLink")
            {
                ...
                // LƯU THÁNG/NĂM ĐANG XEM
                _currentViewingMonth = thang;
                _currentViewingYear = nam;
